...
public class GetNewCrossAreaHandler extends ClientHandler {

    @Override
    public void action() throws Exception {
        GameLocal2CrossMapService service = getService(GameLocal2CrossMapService.class);
        service.getNewCrossArea(getRoleId(), msg.getExtension(GamePb6.GetCrossWarFireAreaRq.ext).getFunctionId());
    }
}
