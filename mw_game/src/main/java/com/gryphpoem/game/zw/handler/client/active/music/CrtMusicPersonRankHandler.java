 ...
 */
public class CrtMusicPersonRankHandler extends ClientHandler {
    @Override
    public void action() throws MwException {
        GamePb4.CrtMusicPersonRankRq req  = msg.getExtension(GamePb4.CrtMusicPersonRankRq.ext);
        ...
        GamePb4.CrtMusicPersonRankRs rsp = service.getPersonRank(player, req);
        sendMsgToPlayer(GamePb4.CrtMusicPersonRankRs.EXT_FIELD_NUMBER, GamePb4.CrtMusicPersonRankRs.ext, rsp);
    }
}
