 ...
 */
public class FinishCreateMusicHandler extends ClientHandler {
    @Override
    public void action() throws MwException {
        GamePb4.FinishCrtMusicRq req  = msg.getExtension(GamePb4.FinishCrtMusicRq.ext);
        ...
        GamePb4.FinishCrtMusicRs rsp = service.finishCreateMusic(player, req);
        sendMsgToPlayer(GamePb4.FinishCrtMusicRs.EXT_FIELD_NUMBER, GamePb4.FinishCrtMusicRs.ext, rsp);
    }
}
