 ...
 */
public class DrawProgressHandler extends ClientHandler {
    @Override
    public void action() throws MwException {
        GamePb4.DrawProgressRq req  = msg.getExtension(GamePb4.DrawProgressRq.ext);
        ...
        GamePb4.DrawProgressRs rsp = service.drawPersonScoreAward(player, req);
        sendMsgToPlayer(GamePb4.DrawProgressRs.EXT_FIELD_NUMBER, GamePb4.DrawProgressRs.ext, rsp);
    }
}
