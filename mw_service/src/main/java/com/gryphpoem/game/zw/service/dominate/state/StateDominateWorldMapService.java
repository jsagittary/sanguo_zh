...
public class StateDominateWorldMapService extends AbsDominateWorldMapService {
    ...
    protected void doRecoverArmy(Player player, Army retreatArmy, Map<Integer, Integer> recoverMap, Map<Long, ChangeInfo> changeMap) {
        for (CommonPb.PartnerHeroIdPb partnerHeroIdPb : retreatArmy.getHero()) {
    ...
    @Override
    protected void attackFightSuccess(FightLogic fightLogic, DominateSideCity sideCity, CommonPb.Report report, Player attackPlayer, Army army, Player defendPlayer, int nowSec) {
    ...
    @Override
    protected void attackFightFailure(FightLogic fightLogic, DominateSideCity sideCity, CommonPb.Report report, Player attackPlayer, Army army, Player defendPlayer, int nowSec) {
