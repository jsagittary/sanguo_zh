...
public class Fighter {
	...
	public boolean isPlayer() {
		return roleType == Constant.Role.PLAYER;
	}
	...
	public boolean dropExp() {
		return roleType == Constant.Role.BANDIT || roleType == Constant.Role.CITY;
	}
     ...
     * @return
     */
    @Deprecated public int getMaxLine(long roleId) {
     ...
     * @return
     */
    @Deprecated public int getDeadLine(long roleId) {
    ...
    public int getKillLine(long roleId) {
        ...
        killLine = auraSkill.getOrDefault(MedalConst.KILL_LINE_KEY, 0);
        return killLine;
    }
    ...
    public void subAuraSkill(Force force) {
        ...
        if (force.roleType == Constant.Role.PLAYER && roleId != 0) {
            Map<Integer, Integer> auraSkill = medalAura.get(roleId);
    ...
    public void addKillLine(Force force) {
        ...
        if (force.roleType == Constant.Role.PLAYER && roleId != 0) {
            ...
            int val = auraSkill.getOrDefault(MedalConst.KILL_LINE_KEY, 0);
            auraSkill.put(MedalConst.KILL_LINE_KEY, val + 1);
            medalAura.put(roleId, auraSkill);
        }
    }
