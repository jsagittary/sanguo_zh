...
public class ShopService {
    ...
    public VipBuyRs vipBuy(Long roleId, int id) throws MwException {
        ...
        if ((staticVip.getVipLv() == VipConstant.VIP_THREE || staticVip.getVipLv() == VipConstant.VIP_EIGHT)
                && !CheckNull.isEmpty(staticVip.getReward())) {
            chatId = staticVip.getVipLv() == VipConstant.VIP_THREE ? ChatConst.CHAT_BUY_VIP3 : ChatConst.CHAT_BUY_VIP8;
            if (chatId > 0) {
