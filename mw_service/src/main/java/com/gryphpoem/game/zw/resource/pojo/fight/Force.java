...
public class Force {
    ...
    public Map<Integer, List<FightSkill>> fightSkill = new HashMap<>();// key: pos, val: 战斗Skill
    ...
    public double getPlaneAtk(int battleType) {
        return calcAttack() + ((battleType == WorldConstant.BATTLE_TYPE_CITY
                || battleType == WorldConstant.BATTLE_TYPE_CAMP) ?
                calcAtkTown() /*+ (isBcs > 0 ? calcDefTown() / 2.00 : 0)*/ :
                0);
    }
    ...
    public double getPlaneDef(int battleType) {
        return calcDefend() + ((battleType == WorldConstant.BATTLE_TYPE_CITY
                || battleType == WorldConstant.BATTLE_TYPE_CAMP) ?
                calcDefTown() /*+ (isIronBas > 0 ? calcAtkTown() / 2.00 : 0)*/ :
                0);
    }
    ...
    @Override public String toString() {
        return "Force{" + "id=" + id + ", hp=" + hp + ", maxHp=" + maxHp + ", armType=" + armType + ", lead=" + lead
                ...
                + isIronBas + ", planeInfos=" + planeInfos + ", treasureWare= " + getTreasureWare() + '}';
    }
