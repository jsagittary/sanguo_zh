...
public class ConnectChannelInboundHandler extends SimpleChannelInboundHandler<Base> {

	private static ConnectChannelInboundHandler ins = new ConnectChannelInboundHandler();

	public static ConnectChannelInboundHandler getIns() {
		return ins;
	}

	private ConnectChannelInboundHandler() {
