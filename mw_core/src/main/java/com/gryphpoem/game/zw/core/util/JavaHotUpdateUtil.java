 ...
 */
public class JavaHotUpdateUtil {
...
//        Files.write(javaSource.getBytes(Charsets.UTF_8), file);
    ...
    private static Class<?> compile(String sourceCode) {
        ...
        DynamicCompiler dynamicCompiler = new DynamicCompiler(JavaHotUpdateUtil.class.getClassLoader());
     ...
     * @throws Exception
     */
    private static Object call(Class<?> methodClass) throws Exception {
     ...
     * @throws Exception
     */
    public static Object hotUpdate(String content) throws Exception {
        // 类dump
        dump(content);
